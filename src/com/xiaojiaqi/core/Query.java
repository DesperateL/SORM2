...
public interface Query {
     ...
     * @return  查询到的结果
     */
    public List queryRows(String sql,Class clazz,Object[] params) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException;
